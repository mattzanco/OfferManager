...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'OfferRevision' AND schema_id = SCHEMA_ID('offermanager'))
BEGIN
    ...
    PRINT 'Created table: offermanager.OfferRevision'
END
ELSE
BEGIN
    PRINT 'Table offermanager.OfferRevision already exists'
END
